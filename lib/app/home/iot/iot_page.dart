                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Center(child: Text("Production Quality Engineer", style: TextStyle(color: Colors.white, fontSize: 27, fontWeight: FontWeight.w400),)),
                    ),
                     Padding(
                      padding: const EdgeInsets.only(top: 10.0, bottom: 40, left: 30),
                      child: Center(child: Text("Utilizing 5G /n/n Faster production quality inspections", style: TextStyle(color: Colors.white, fontSize: 17.5, fontWeight: FontWeight.w300),)),
                    ),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
